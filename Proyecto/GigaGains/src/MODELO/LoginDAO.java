...
public class LoginDAO {
    ...
    public login log(String usuario, String contrasena) {
        login l = new login();
        String sql = "SELECT * FROM usuario WHERE email = ? AND contrasena = ?"; // Consulta para verificar las credenciales
        ...
        try {
            ...
            ps.setString(2, contrasena);  // Establecer el valor para la contraseña
            ...
            if (rs.next()) {
                ...
                l.setPass(rs.getString("contrasena"));  // Asignar la contraseña al objeto login
